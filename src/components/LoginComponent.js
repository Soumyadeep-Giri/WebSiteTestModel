            ...
            <div className="card mb-3 loginCard">
                <div className="row g-0">
                    <div className="col-md-4">
                        <img src="https://images.unsplash.com/photo-1555992303-c94a96ab093e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=464&q=80" className="img-fluid rounded-start" alt="..." />
                    </div>
                    <div className="col-md-8">
                        <div className="card-body">
                            ...
                            <div className="login-links">
                                <p className="text-center">Don't have an account? <a className="txt-brand" href="#">Sign up</a></p>
                            </div>
                        </div>
                    </div>
                </div>
